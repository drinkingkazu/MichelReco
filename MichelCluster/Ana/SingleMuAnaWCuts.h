...
/** \addtogroup MichelCluster
    ...
    @{*/
#ifndef SINGLEMUANAWCUTS_H
#define SINGLEMUANAWCUTS_H
...
namespace michel {
  /**
     \class SingleMuAnaWCuts
     User defined class SingleMuAnaWCuts ... these comments are used to generate
     doxygen documentation!
  */
  class SingleMuAnaWCuts : public MichelAnaBase {
    
  public:
    
    /// Default constructor
    SingleMuAnaWCuts(){ _verbosity = msg::kNORMAL; }
